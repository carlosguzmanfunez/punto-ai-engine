...
class AuditEventType(StrEnum):
    ...
    RESOURCE_WAIT_ENTERED = "RESOURCE_WAIT_ENTERED"
    RESOURCE_WAIT_UPDATED = "RESOURCE_WAIT_UPDATED"
    RESOURCE_WAIT_RESOLVED = "RESOURCE_WAIT_RESOLVED"
    RESOURCE_WAIT_REEVALUATED = "RESOURCE_WAIT_REEVALUATED"
    RESOURCE_WAIT_CYCLE = "RESOURCE_WAIT_CYCLE"
    #: MULTI-TASK FASE 6: DAG operacional de dependencias entre Tasks (WAITING_DEPENDENCY).
    DEPENDENCY_WAIT_ENTERED = "DEPENDENCY_WAIT_ENTERED"
    DEPENDENCY_WAIT_UPDATED = "DEPENDENCY_WAIT_UPDATED"
    DEPENDENCY_WAIT_RESOLVED = "DEPENDENCY_WAIT_RESOLVED"
    DEPENDENCY_WAIT_REEVALUATED = "DEPENDENCY_WAIT_REEVALUATED"
    #: MULTI-TASK FASE 7: BUSY del ProviderLease es espera operativa, nunca fallo.
    PROVIDER_WAIT_ENTERED = "PROVIDER_WAIT_ENTERED"
    PROVIDER_WAIT_UPDATED = "PROVIDER_WAIT_UPDATED"
    PROVIDER_WAIT_RESOLVED = "PROVIDER_WAIT_RESOLVED"
    PROVIDER_WAIT_REEVALUATED = "PROVIDER_WAIT_REEVALUATED"
    #: MULTI-TASK FASE 8A: RECOVERY operacional sin candidato elegible ahora mismo.
    RECOVERY_WAIT_ENTERED = "RECOVERY_WAIT_ENTERED"
    RECOVERY_WAIT_UPDATED = "RECOVERY_WAIT_UPDATED"
    RECOVERY_WAIT_RESOLVED = "RECOVERY_WAIT_RESOLVED"
    RECOVERY_WAIT_REEVALUATED = "RECOVERY_WAIT_REEVALUATED"
