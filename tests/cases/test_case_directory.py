...
def test_el_directorio_canonico_carga_completo() -> None:
    ...
    # 20 casos canónicos + los 3 de autoridad adaptativa que añade PILOT-05 (expansión causal,
    # escalada de autoridad denegada y protección constitucional).
    assert len(CASES) == 23, "el directorio canónico declara veintitrés casos"
