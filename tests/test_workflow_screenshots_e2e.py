...
class PassingQA(QARunner):
    """QA doble que aprueba y declara su uso de modelo, porque su informe cuenta llamadas."""
...
class PassingSecurity(SecurityRunner):
    """Security doble que aprueba y declara su uso de modelo, porque su informe cuenta llamadas."""
...
class PassingReviewer(ReviewerRunner):
    """Reviewer doble que aprueba y declara su uso de modelo, porque su informe cuenta llamadas."""
