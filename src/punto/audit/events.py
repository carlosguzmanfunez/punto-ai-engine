...
RESOURCE_BY_EVENT: Final[dict[AuditEventType, str]] = {
    ...
    AuditEventType.RESOURCE_WAIT_ENTERED: "resource_wait",
    AuditEventType.RESOURCE_WAIT_UPDATED: "resource_wait",
    AuditEventType.RESOURCE_WAIT_RESOLVED: "resource_wait",
    AuditEventType.RESOURCE_WAIT_REEVALUATED: "resource_wait",
    AuditEventType.RESOURCE_WAIT_CYCLE: "resource_wait",
    AuditEventType.DEPENDENCY_WAIT_ENTERED: "dependency_wait",
    AuditEventType.DEPENDENCY_WAIT_UPDATED: "dependency_wait",
    AuditEventType.DEPENDENCY_WAIT_RESOLVED: "dependency_wait",
    AuditEventType.DEPENDENCY_WAIT_REEVALUATED: "dependency_wait",
    AuditEventType.PROVIDER_WAIT_ENTERED: "provider_wait",
    AuditEventType.PROVIDER_WAIT_UPDATED: "provider_wait",
    AuditEventType.PROVIDER_WAIT_RESOLVED: "provider_wait",
    AuditEventType.PROVIDER_WAIT_REEVALUATED: "provider_wait",
    AuditEventType.RECOVERY_WAIT_ENTERED: "recovery_wait",
    AuditEventType.RECOVERY_WAIT_UPDATED: "recovery_wait",
    AuditEventType.RECOVERY_WAIT_RESOLVED: "recovery_wait",
    AuditEventType.RECOVERY_WAIT_REEVALUATED: "recovery_wait",
